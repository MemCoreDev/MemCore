...
class Message:
    """Message class to store the contexts, MemCore stream and knowledge entity store."""
    ...
    def __str__(self):
        ...
        for MemCore in self.llm_message["MemCore_stream"]:
            llm_message_str += f"{str(MemCore)},"
