...
from ailive.agent.data_types import Context, Message
from ailive.agent.llm_api.tools import (ollama_chat_completions_request,
                                        openai_chat_completions_request)
from ailive.MemCore import EntityKnowledgeStore, MemCoreStream
from ailive.synonym_expand.synonym import custom_synonym_expand_fn
...
class Agent(object):
    """Agent manages the RAG model, the ReAct agent, and the MemCore stream."""
    ...
    def __init__(
        ...
        self.MemCore_stream = MemCoreStream(MemCore_stream_json)
    ...
    def _change_llm_message_chat(self) -> dict:
        ...
        llm_message_chat.pop("MemCore_stream")
    ...
    def _init_default_tools(self, default_tools: List[str]):
        """Initializes ReAct Agent from the default list of tools ailive provides.
